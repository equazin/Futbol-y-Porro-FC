...
-- Adds update_candidate_by_dni so candidates can edit their partido
-- and 13 propuesta fields while postulaciones are open. Auth: DNI of
-- president OR vice of that candidacy.
